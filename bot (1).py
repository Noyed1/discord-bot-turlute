...
# ============================================================
#  Boucle de vérification inactivité (RIP)
# ============================================================
...
async def on_message(message):
    ...
    if message.channel.id == RIP_CHANNEL_ID:
        ...
        # 67 ou six seven → SIX SEVEN 67 SIX SEVEN 67
        if "67" in content or re.search(r'\bsix.?seven\b', content_lower):
            await message.channel.send("SIX SEVEN 67 SIX SEVEN 67")
            print(f"🎵 SIX SEVEN envoyé pour {message.author.display_name}")

        # Fuck → fuck balu
        if "fuck" in content_lower:
